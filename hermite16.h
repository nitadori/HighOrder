...
struct Corrector{
	...
	void correct(const Particle &p, const Force &f){
		...
		const dd_real c7 = c6 * (dd_real::div(1., 7.) * h);

		const dd_real d0 = c0;
		const dd_real d1 = dd_real::div( 7.,   15.) * c1;
		const dd_real d2 = dd_real::div(12.,   45.) * c2;
		const dd_real d3 = dd_real::div( 2.,   13.) * c3;
		const dd_real d4 = dd_real::div(16.,  195.) * c4;
		const dd_real d5 = dd_real::div(16.,  429.) * c5;
		const dd_real d6 = dd_real::div(64., 5005.) * c6;
		const dd_real d7 = dd_real::div(16., 6435.) * c7;
	...
	void interpolate(const Particle &p, const Force &f){
		...
		// rescale
		{
			...
			const dd_real s14= s13*(14.*hi);
			const dd_real s15= s14*(15.*hi);
